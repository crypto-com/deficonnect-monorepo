...
Notably, the [`WalletConnectProvider`](./src/providers/WalletConnectProvider.tsx) optionally accepts `WalletConnect` configuration arguments as defined by the [`IWalletConnectOptions`](https://github.com/monacohq/walletconnect-monorepo/tree/next/packages/helpers/utils) interface:
